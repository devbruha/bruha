...
<style>
    .eventContent.listViewContent > .yellowButton{
        float: left;
        clear: none;
    }
    ...
    #map_event_list > div > div:first-child{
        margin-top: 60px;
    }
                ...
                minAge = json_obj[0].event_min_age;
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            var clickedLat = Number(marker.getPosition().lat()) - Number(0.0001);
...
function addToList(allMarkers,i){
    ...
    var d = new Date(allMarkers.start_date_time_start_date);
    ...
    eventContent += '<a  class="yellowButton viewEventListView" href="http://showdom.com/index.php/mobile/viewEvent/'+allMarkers.event_id+'">VIEW EVENT</a>';
    eventContent += '</div>';
