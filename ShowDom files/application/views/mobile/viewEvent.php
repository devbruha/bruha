...
<div id="popupMobile" style="display: none">
    <div id="userInformation">
        <div>
            ...
            <div class="socialLinks">
                ...
                <?php
                if($facebookLink != ''){
                    //echo '<a href="javascript:web(\''.$facebookLink.'\');" target="_blank">';
    ...
    <div id="viewEvent">
        ...
        if($eventData->event_tickets != ''){
            echo '<a target="_blank" href="'.$eventData->event_tickets.'" class="yellowButton bold sixteen">GET TICKETS</a>';
        }
        /*
        if(isset($isFav)){
            if($isFav != 0){
        ...
        */
        ...
        $numVids = count($video);
        if($numVids != 0){
            echo '<div class="googleMapsInfoWindowInner quickEventContainer clearfix">';
            ...
            <?php
                ...
                <iframe style="z-index:0" width="400" height="320" src="http://www.youtube.com/embed/<?php echo $vid->video_youtube; ?>?autoplay=0&wmode=opaque" frameborder="0" allowTransparency="true"></iframe>
            <?php }else{ ?>
                <div class="jp-title"><?php echo $vid->video_title; ?></div>
                <iframe src="http://player.vimeo.com/video/<?php echo $vid->video_youtube; ?>" width="400" height="320" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
            <?php }
                echo '</div>';
        ...
        */
        ...
        <?php
            ...
            //echo '<iframe width="300" height="24" src="http://www.youtube.com/embed/'.$aud->audio_url.'?rel=0&autohide=0&#8243; frameborder="0" allowfullscreen></iframe>';
            ?>
            <span style="display: block;margin: 10px 0; position: relative;">Click To Play</span>
            <div style="position:relative;width:267px;height:25px;overflow:hidden;">
                <div style="position:absolute;top:-264px;left:-5px">
                    <iframe width="300" height="300"
                            src="https://www.youtube.com/embed/<?php echo $aud->audio_url; ?>?rel=0&autohide=2" frameborder="0" allowfullscreen="0">
                    </iframe>
                </div>
            </div>
            ...
            echo '<div class="jp-title">'.$aud->audio_caption.'</div>';
            echo '<iframe src="http://player.vimeo.com/video/'.$aud->audio_url.'" width="400" height="55" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
        }
            echo '</div>';
        }
            echo '</div>';
        ...
        */
        ...
        if($numPhotos != 0){
            foreach($photos as $photo){
                $imageCounter ++;
                if($imageCounter <=7){
                    echo '<a rel="view_photo_group" class="enlargePhoto" href="'.base_url().'themes/showdom/images/events/'.$eventData->event_id.'/gallery/'.$photo->photo_file.'">
                                            <img src="'.base_url().''.image("themes/showdom/images/events/".$eventData->event_id."/gallery/".$photo->photo_thumb, 100, 80).'" />
                                        </a>';
                }else{
                    $imageLeftCounter ++;
                    echo '<a style="display:none" rel="view_photo_group" class="enlargePhoto" href="'.base_url().'themes/showdom/images/events/'.$eventData->event_id.'/gallery/'.$photo->photo_file.'">
                                            <img src="'.base_url().''.image("themes/showdom/images/events/".$eventData->event_id."/gallery/".$photo->photo_thumb, 100, 80).'" />
                                        </a>';
                }
            }
