...
<div id="viewEvent">
    <div>
        <h3 style="text-transform: uppercase"><?php echo $showdomId; ?> PROFILE & EVENTS</h3>
...
<script>
    $(document).ready(function(){
        ...
        $(window).scroll(function() {
            if (($("#viewEvent").offset().top + $("#viewEvent").height() - $(window).height()) <= $(window).scrollTop()+100) {
                if(loadingEvents == false){
                    loadingEvents = true;
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/mobile/reloadViewProfileEvents",
