...
<script async type="text/javascript" src="<?php echo base_url(); ?>themes/showdom/js/main.js"></script>
</head>
<body onload="initialize(); " class="notLoggedIn">
...
<div id="header">
    <div id="headerInner">
        ...
        <div id="downloadMobileApps" class="downloadMobileApps">
