<div id="popup">
    <div id="popupInner" class="clearfix">
        ...
        <div id="popupInnerRight">
                ...
                <strong>COST: $<?php echo number_format($getAdCost,2); ?> </strong>
                <br/>
                <br/>
                ...
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    ...
                    <input type="hidden" name="return" value="<?php echo base_url(); ?>index.php/ads/adPaymentComplete" />
				...
				?>
                <br/>
                <form id="standardForm" method="post" action="<?php echo base_url(); ?>index.php/ads/payWithCode">
                	<div class="formWrap clearfix">
                    	<label>Code: </label>
