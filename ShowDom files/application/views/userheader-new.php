...
<head>
    ...
    <meta name="description" content="<?php if($meta_description){ echo $meta_description; }else{ echo 'Upload, manage and discover shows and events in your area for various artistries: music, film/theatre, art/write, fashion, comedy and other'; } ?>">
    ...
    <script src="<?php echo base_url(); ?>themes/showdom/js/jquery-ui.js"></script>
    ...
    <script type="text/javascript">
        ...
        var zoomLevel = "<?php echo $zoomCookie; ?>";
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>themes/showdom/js/main-new.js"></script>
...
<div id="headerSmall">
    <div id="headerInner">
        ...
        <div id="downloadMobileApps">
            <span>Mobile Apps</span>
            <a id="downloadAndropdApp" href="https://play.google.com/store/apps/details?id=com.Showdom.MobileApp" target="_blank"></a>
            <a id="downloadIphoneApp" href="https://itunes.apple.com/us/app/showdom/id703495429?mt=8" target="_blank"></a>
        </div>

        <a id="createAnEvent2" href="http://showdom.com/index.php/events/add">Create Event</a>
