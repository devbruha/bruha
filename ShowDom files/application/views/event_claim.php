    ...
    <div id="popupInner" class="clearfix">
        ...
        <div id="popupInnerRight" class="viewEvent">
           <?php
                ...
                <form id="standardForm" class="standardForm standardForm2" method="post" action="<?php echo base_url(); ?>index.php/events/claimSubmit">
                    <div class="clear-20"></div>
                    <h1>Claim This Event</h1>
                    <div class="clear-10"></div>

                    <div class="formLeft">
                        <div class="formWrap clearfix">
                            <label>Showdom Id: </label>
                            <input type="text" name="name" value="<?php echo $showdomId; ?>" readonly="readonly" />
                        </div>
                        <div class="formWrap clearfix">
                            <label>Email: </label>
                    ...
                    <div class="formRight">
                        ...
                        <div class="formWrap clearfix">
                            <input class="yellowButton sixteen bold" type="submit" value="Claim Event Now" />
                        </div>
                    </div>
                    <input type="hidden" name="eventId" value="<?php echo $eventData->event_id; ?>" />
                </form>
